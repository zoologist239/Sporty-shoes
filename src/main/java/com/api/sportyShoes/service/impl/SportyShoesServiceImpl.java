...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	public void init() {
		...
		Shoe s3 = new Shoe(3,"Shoe Name 3","Racing",900.24);
		...
		Date d = new Date(0);
		PurchaseReport pr1 = new PurchaseReport(5,"user_1","Racing",d,"adidas_racer:5,nike_airmax:10");
	...
	public Shoe getShoeById(int id) throws BusinessException {
		...
		try {
			...
			throw new BusinessException("Shoe not found with  this Id: "+id);
		}
		return shoe;
	}
